 ...
 * 
 * Simulator for Baggage Sorting System --- RCX LCD Display
 *
 * @author hhl
 ...
 * LCD routines.
 * 
 * Only partly simulated by printing to standard output
 * 
 */
public class LCD
{
  ...
  {
	  System.out.println("LCD Display: " + aValue);
...
*/  }
  ...
  {
	  System.out.println("LCD Prog:" + aValue);
...
//    ROM.call ((short) 0x27c8);
  ...
  {
//    ROM.call ((short) 0x1b62, (short) aCode);
  }
  ...
  {
//    ROM.call ((short) 0x1e4a, (short) aCode);
  }
